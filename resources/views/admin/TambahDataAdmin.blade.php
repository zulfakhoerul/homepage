        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                        <h3 class="title-5 m-b-35">Tambah Data Admin</h3>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @endif
                                        <form action="{{url('AksiTambahDataAdmin')}}" method="post"  class="form-horizontal">
                                        {{csrf_field()}}
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama_admin" name="nama_admin" placeholder="Masukan Nama" class="form-control">
