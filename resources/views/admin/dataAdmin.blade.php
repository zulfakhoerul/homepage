                    ...
                    <li>
                        ...
                        <li>
                            <a class="js-arrow" href="#">
                                <i class="fa fa-users"></i>Tabel Data</a>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                            <a href="{{url ('admin/TambahDataAdmin')}}" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        ...
                                        @foreach($datas as $tampil)
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="{{ url ('admin/UbahDataDokter'.$tampil->id_dokter) }}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    
                                                    <a href="{{ url ('HapusDataAdmin'.$tampil->id_admin) }}" class="item" data-toggle="tooltip" 
